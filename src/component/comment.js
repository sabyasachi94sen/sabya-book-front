...
const Comment = ({ post_status, post_profile_pic, setComments, fetchPost, createdAt, comments, user_id, post_id, post_user_id, user, text_post, pic_post, likes, share, is_user_liked, handlePostStatus }) => {
        ...
        try {
            ...
            for (let i = 0; i < user_comment.length; i++) {
                if (user_comment[i]?._id == _id) {
                    ...
                    console.log(user_comment[i].reply, "aa");
                }
            }
    ...
    return (
        <div className='comment-parent-wrapper'>
            ...
            <div className={`comment-wrapper`}>
                ...
                <div className='other-comment-wrapper' style={{ height: url != "home" && "" }}>
